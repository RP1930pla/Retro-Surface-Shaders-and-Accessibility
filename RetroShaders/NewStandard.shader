...
Shader "NewStandard"
{
	...
	SubShader
	{
		...
		#pragma target 4.6
		#pragma multi_compile __ _NOFPU_ON
		...
		struct Input
		{
			...
			float3 worldPos;
			float2 uv_texcoord;
			float2 vertexToFrag4_g21;
			float2 vertexToFrag4_g16;
			float2 vertexToFrag4_g15;
			float2 vertexToFrag4_g20;
		};
		...
		float MyCustomExpression66_g22( float vertexin, int Pixels )
		{
			float result;
		...
		float MyCustomExpression65_g22( float vertexin, int Pixels )
		{
			float result;
			result = floor(Pixels * vertexin) / Pixels;
			return result;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4x4 invertVal79_g22 = Inverse4x4( UNITY_MATRIX_MVP );
			float4 unityObjectToClipPos49_g22 = UnityObjectToClipPos( ase_vertex3Pos );
			float4 SnapToPixel54_g22 = unityObjectToClipPos49_g22;
			float4 vertex55_g22 = SnapToPixel54_g22;
			float4 break57_g22 = vertex55_g22;
			float3 appendResult58_g22 = (float3(break57_g22.x , break57_g22.y , break57_g22.z));
			float4 appendResult62_g22 = (float4(( appendResult58_g22 / SnapToPixel54_g22.w ) , break57_g22.w));
			float4 break63_g22 = appendResult62_g22;
			float vertexin66_g22 = break63_g22.x;
			int Pixels66_g22 = ( _HorizontalResolution / 2 );
			float localMyCustomExpression66_g22 = MyCustomExpression66_g22( vertexin66_g22 , Pixels66_g22 );
			float vertexin65_g22 = break63_g22.y;
			int Pixels65_g22 = ( _VerticalResolution / 2 );
			float localMyCustomExpression65_g22 = MyCustomExpression65_g22( vertexin65_g22 , Pixels65_g22 );
			float3 appendResult69_g22 = (float3(localMyCustomExpression66_g22 , localMyCustomExpression65_g22 , break63_g22.z));
			float4 appendResult73_g22 = (float4(( appendResult69_g22 * SnapToPixel54_g22.w ) , break63_g22.w));
			#ifdef _NOFPU_ON
				float4 staticSwitch94 = mul( invertVal79_g22, appendResult73_g22 );
			#else
			...
			float4 unityObjectToClipPos2_g21 = UnityObjectToClipPos( ase_vertex3Pos );
			o.vertexToFrag4_g21 = ( uv_Albedo * unityObjectToClipPos2_g21.w );
			...
			float4 unityObjectToClipPos2_g20 = UnityObjectToClipPos( ase_vertex3Pos );
			o.vertexToFrag4_g20 = ( uv_Occlusion * unityObjectToClipPos2_g20.w );
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 unityObjectToClipPos5_g21 = UnityObjectToClipPos( ase_vertex3Pos );
			#ifdef _AFFINETEXTUREMAPPING_ON
				float2 staticSwitch57 = ( i.vertexToFrag4_g21 / unityObjectToClipPos5_g21.w );
			#else
			...
			float4 unityObjectToClipPos5_g20 = UnityObjectToClipPos( ase_vertex3Pos );
			#ifdef _AFFINETEXTUREMAPPING_ON
				float2 staticSwitch135 = ( i.vertexToFrag4_g20 / unityObjectToClipPos5_g20.w );
			#else
...
/*ASEBEGIN
Version=18935
1913;6;1920;1013;4225.604;1031.61;1.742016;True;False
...
Node;AmplifyShaderEditor.FunctionNode;134;-3030.952,2350.336;Inherit;False;AffineTM;-1;;20;1253b9ff3f307ed47846b90f0972e7f5;0;1;9;SAMPLER2D;0;False;2;SAMPLER2D;10;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;104;-3083.407,-785.9377;Inherit;False;AffineTM;-1;;21;1253b9ff3f307ed47846b90f0972e7f5;0;1;9;SAMPLER2D;0;False;2;SAMPLER2D;10;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;114;-2211.103,371.7734;Inherit;False;Property;_EmissionColor;Emission Color;7;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;57;-2883.538,-663.2827;Inherit;False;Property;_AffineTextureMapping;Affine Texture Mapping;9;0;Create;True;0;0;0;True;0;False;1;0;0;True;_affine_tex;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;88;-594.1214,602.401;Inherit;False;NoFPU;-1;;22;85d694b10abf39c488fd8fa5d47212dd;0;2;81;INT;160;False;82;INT;120;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.StaticSwitch;94;-264.1794,626.8082;Inherit;False;Property;_NoFPU;No FPU;10;0;Create;True;0;0;0;True;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=FE1F8A7A5AFCE16C7A9CE654582880C80F802DAB